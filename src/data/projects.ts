...
const bootstrapLabel: Label = {
  name: "Bootstrap",
  background: grape,
  color: "white",
};
const chromeExtensionLabel: Label = {
  name: "Extension",
  background: mintGreen,
  color: "white",
};
const cssLabel: Label = { name: "CSS", background: yellow, color: "black" };
const expressLabel: Label = {
  name: "Express",
...
const materializeLabel: Label = {
  name: "Materialize",
  background: blue,
  color: "white",
};
const materialUILabel: Label = {
  name: "Material\xa0UI",
  background: blue,
  color: "white",
};
...
const projects: IProject[] = [
  {
    ...
    shortDescription:
      "Sing along to latin language music, with the lyrics available ahead of time in Latin & English.",
  ...
  },
  {
    ...
    shortDescription:
      "Practice Latin vocab from books such as LLPSI with Latin pronunciations and a review mode.",
  ...
  },
  {
    ...
    shortDescription:
      "Practice the doomsday rule to find the day of the week of any date in your head.",
  ...
  },
  {
    ...
    shortDescription:
      "Practice Latin declensions (noun suffixes) using the Dowling method.",
  ...
  },
  {
    ...
    shortDescription:
      "A website to upload images, similar to imgur. Built with AWS S3.",
  ...
  },
  {
    ...
    shortDescription:
      "A chrome extension with a prompt before purchasing on amazon.",
  ...
  },
  {
    title: "Sentimentsion",
    shortDescription:
      "A chrome extension that highlights how positive/negative text is.",
  ...
  },
  {
    ...
    shortDescription:
      "CS history backgrounds I would leave on the projector during breaks.",
